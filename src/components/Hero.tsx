      ...
      <section className="relative py-20 px-4 min-h-[calc(100vh-80px)] flex items-center">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center bg-white/10 lg:backdrop-blur-md p-8 rounded-xl border border-white/20 shadow-lg">
          ...
          <div className="text-left text-white">
            <p className="text-primary font-semibold text-lg mb-2 flex items-center justify-start">
            ...
            <div className="flex items-center justify-center md:justify-start gap-4">
              <Link href="/projects" className="bg-white/20 text-white font-semibold py-2 px-6 md:py-3 md:px-8 rounded-full shadow-lg transform hover:scale-105 transition-transform duration-300 border border-white/30">
                Proven Solutions
              </Link>
              <Link href="/#contact" className="bg-white/10 text-white font-semibold py-2 px-6 md:py-3 md:px-8 rounded-full shadow-lg transform hover:scale-105 transition-transform duration-300 border border-white/30">
                Let's Collaborate
              </Link>
            </div>
          </div>
